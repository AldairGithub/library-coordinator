...
public class PatronServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// localhost:8080/LibraryCoordinator/LibraryServlet/abc -> "abc" is the ending
		// url
...
//			response.sendRedirect("/");
	...
	private void renting(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException, ServletException {
		// TODO Auto-generated method stub
...
//	}
	...
	private void newPatron(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (added) {
			...
			response.sendRedirect(request.getContextPath() + "/patron_pages/newPatron-form.jsp");
		}
	}
